...
export const mockExperts = [
  ...
  },
  {
    ...
    category: 'Business',
    tags: ['Strategist', 'Teacher', 'Author'],
    bio: 'CMO at PSEB. Strategist, teacher and author helping leaders and organisations grow through clarity and action.',
    rating: 4.9,
    sessions: 124,
    startingPrice: 250,
    verified: true,
  },
  {
    ...
    category: 'Finance',
    tags: ['Strategic Consultant', 'Author', 'Auditor'],
    bio: 'Experienced CPA with MBA in Business Administration and Accounting. Strategic consultant, author, and auditor.',
    rating: 5.0,
    sessions: 89,
    startingPrice: 400,
    verified: true,
  },
  {
    id: 11,
    name: 'Chris Tibbetts',
    handle: 'christibbetts',
    image: '/images/Chris-Tibbetts.png',
    category: 'Coaching',
    tags: ['Entrepreneurship', 'Growth Strategy', 'Leadership'],
    bio: 'Serial entrepreneur and business growth expert helping high performers break through barriers and scale with confidence.',
    rating: 4.9,
    sessions: 97,
    startingPrice: 350,
    verified: true,
  },
  {
    ...
    category: 'Creative',
    tags: ['Performance Marketing', 'Brand Positioning', 'CRO'],
    bio: 'Growth Marketing Director with a decade of experience driving revenue through data-driven performance and brand strategy.',
    rating: 4.8,
    sessions: 215,
    startingPrice: 180,
    verified: true,
  },
  {
    ...
    category: 'Finance',
    tags: ['Investment Strategy', 'Pitch Deck Review', 'Market Analysis'],
    bio: 'Venture Capital Partner helping founders raise smart money. Expert in pitch decks, market sizing, and early-stage strategy.',
    rating: 4.9,
    sessions: 56,
    startingPrice: 300,
    verified: true,
